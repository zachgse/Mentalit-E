        ...
        <div class="col-lg-9">
            ...
            <div class="shadow p-5 w-100 standard">
                ...
                @if($booking->status == "To Cancel")
                    <h4 class="text-center my-5">Reason for Cancelling the booking</h4>

                    <div class="mb-3 w-100 auto">
                        <label for="exampleInputEmail1" class="form-label bold pull-left">Reason: </label>
                        <br><br>
                        <p class="pull-left ms-5">{{$booking->reason}}</p>
                    </div>
                ...
                @elseif ($booking->status == "In Progress")
                    ...
                    <div class="mb-3 w-100 auto">
                        ...
                        <br><br>
                        <p class="pull-left ms-5">{{ \Carbon\Carbon::parse($record->dateTime)->format('F j , Y')}}</p>
                    </div>
                    ...
                    <div class="mb-3 w-100 auto">
                        ...
                        <a href="{{asset('storage/bookingRemarks/' . $record->fileUpload)}}" download>
                            <button class="btn btn-outline pull-left" onclick="return confirm('Download the item?')">Download</button>
                        </a>
                    </div>  
                    @endif   
                @elseif ($booking->status == "To Rate" || $booking->status == "Done")
                    @if ($rating == null)
                    <h4 class="text-center my-5">Booking Remarks</h4>
                    ...
                    <h4 class="text-center my-5">Booking Ratings</h4>
                    ...
                    <div class="mb-3 w-100 auto">
                        <label for="exampleInputEmail1" class="form-label bold pull-left">Comments / Suggestions by the patient: </label>
                        <br><br>
                        <p class="pull-left ms-5">{{$rating->ratingDescription}}</p>
                    </div>                    
