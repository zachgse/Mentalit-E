                                    ...
                                    <select data-column="1" type="text" class="text-center form-control filter-select pointer">
                                        <option value="">Filter</option>  
                                            @foreach($patient as $p)                       
                                                <option value="{{$p->userPatient->email}}">
                                                    {{$p->userPatient->email}}
                                                </option>
                                            @endforeach
                                    </select>
...
$(function () {
    ...
    var table = $('#booking-table').DataTable({
        ...
        columns: [
            ...
            {data: 'employeeBooking', name: 'employeeBooking.lastName', searchable: true, sortable : true, visible: true},
            {data: 'bookingDate', name: 'bookingDate', searchable: true, sortable : true, visible: true},
            {data: 'created', name: 'created', searchable: true, sortable : true, visible: true},
            {data: 'status', name: 'status', searchable: true, sortable : true, visible: true},
            {data: 'payment', name: 'payment', searchable: false, sortable : false, visible: true},
