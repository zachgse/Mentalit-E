...
<div class="container">
    ...
    <br>
        ...
        <form method="POST" action="/booking/{{$service->id}}/quick-display-store" enctype="multipart/form-data">
            @csrf
            <div>
            ...
            <div>
                <p><b>Service Length:</b> {{$service->serviceLength}} hour/s</p>
            </div>            
            ...
            <div class="d-flex bd-highlight justify-content-center">
				<div class="bd-highlight m-2">
                    ...
                    min="{{$start}}" max="{{$end}}"  required autocomplete="start" required>
                    @error('start')
            ...
            <div class="d-flex justify-content-center">
                <div class="d-flex p-2 bd-highlight">            
                    <input class="form-control @error('payment') is-invalid @enderror" type="file" name="payment" accept="image/*, application/pdf, application/msword, .doc, .docx" required autocomplete="payment">
                    @error('payment')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="d-flex p-2 bd-highlight">
                    ...
                    @include('inc.quick-clinic-modal')
                </div>        
            </div>
