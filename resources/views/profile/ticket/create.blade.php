...
<div class="container">
    ...
    <div class="shadow-lg p-3 mb-5 rounded w-50 m-auto">
        ...
        <form method="POST" action="/profile/ticket" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-3 w-75 auto">
                ...
                <input class="form-control w-75 auto @error('file') is-invalid @enderror" type="file" name="file" accept="image/*, application/pdf, application/msword">	   
                @error('file')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
