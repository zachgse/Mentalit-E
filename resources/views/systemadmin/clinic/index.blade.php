    ...
    @include('inc.profile')		
        ...
        <div class="col-lg-9">
            ...
            <div class="shadow p-5 w-100 standard">
                ...
                <h2 class="text-center">List of clinics</h2>
...
$(function () {
    ...
    $('#clinic-table').DataTable({
        ...
        columns: [
            ...
            {data: 'clinicEmail', name: 'clinicEmail', searchable: true, sortable : true, visible: true},
            {data: 'clinicAdminName', name: 'clinicAdminName', searchable: true, sortable : true, visible: true},
            {data: 'subscriptionDuration', name: 'subscriptionDuration', searchable: true, sortable : true, visible: true},
