...
<div class="container">
    ...
    <div class="shadow-lg p-3 mb-5 rounded w-50 m-auto">
        ...
        <div class="d-flex justify-content-between">
            ...
            <div class="p-2 bd-highlight">
                <h4 class="text-center">Notify a user</h4>
            </div>
        ...
        <form method="POST" action="/systemadmin/user/{{$var->id}}/storenotification">
            @csrf
            ...
            <button class="btn btn-outline" type="submit" onclick="return confirm('Send a notification to the user?')">Submit</button>
