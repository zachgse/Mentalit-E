            ...
            <div class="shadow p-5 w-100 standard">
                ...
                <div class="d-flex bd-highlight mb-3">
                    <div class="me-auto p-2 bd-highlight">
                        <a href="/systemadmin/ticket/create">
                ...
                <div class="table-responsive-xl">
                    <table class="table table-bordered" id="sysad-ticket-table">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>User</th>
...
$(function () {
    ...
    $('#sysad-ticket-table').DataTable({
        processing: true,
        serverside: true,
        responsive: true,
        "scrollX": true,
        ajax: "/systemadmin/ticket/list",
        columns: [
            {data: 'DT_RowIndex', name: 'DT_RowIndex', searchable: true, sortable : true, visible: true},
            {data: 'userEmail', name: 'userEmail.email', searchable: true, sortable : true, visible: true},
            ...
            {data: 'dateTimeUpdated', name: 'dateTimeUpdated', searchable: true, sortable : true, visible: true},
