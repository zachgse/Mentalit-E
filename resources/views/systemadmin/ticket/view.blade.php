        ...
        <div class="col-lg-9">
            ...
            <div class="shadow p-5 w-100 standard">
                ...
                @if($var->ticketStatus != "Closed" && $var->ticketStatus != "Archived")
                    ...
                    <br>
                    <form method="POST" action="/systemadmin/ticket/{{$var->id}}" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mt-5 w-50 auto">
                        ...
                        <input class="form-control w-75 auto @error('file') is-invalid @enderror" accept="image/*, application/pdf, application/msword, .doc, .docx" type="file" name="file">
                        @error('file')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
